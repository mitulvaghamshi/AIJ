...
public class CircleImageView extends AppCompatImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        @SuppressLint("Recycle") TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CircleImageView, defStyle, 0);
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CircleImageView_civ_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.CircleImageView_civ_border_color, DEFAULT_BORDER_COLOR);
        boolean DEFAULT_BORDER_OVERLAY = false;
    ...
    private Bitmap getBitmapFromDrawable(Drawable drawable) {
        ...
        try {
            Bitmap bitmap;
            int COLOR_DRAWABLE_DIMENSION = 2;
            bitmap = drawable instanceof ColorDrawable
