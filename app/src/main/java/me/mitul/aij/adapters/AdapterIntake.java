...
public class AdapterIntake extends BaseAdapter {
    ...
    private static class ViewIntakeHolder {
        ...
        private ViewIntakeHolder(View view) {
            txtClgDetailListBranch = view.findViewById(R.id.intakedetail_listview_branch);
            txtClgDetailListSeat = view.findViewById(R.id.intakedetail_listview_seat);
            txtClgDetailListVecent = view.findViewById(R.id.intakedeatail_listview_vecant);
        }
    }
}
