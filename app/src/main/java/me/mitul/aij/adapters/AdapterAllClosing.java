...
import me.mitul.aij.models.AllClosingList;
...
public class AdapterAllClosing extends BaseAdapter {
    ...
    private static class ViewAllClosingHolder {
        ...
        private ViewAllClosingHolder(View view) {
            closingTextViewBranchName = view.findViewById(R.id.allclosing_tv_branch);
            closingTextViewTfwsValue = view.findViewById(R.id.allclosing_tv_tfw);
            closingTextViewOpenValue = view.findViewById(R.id.allclosing_tv_open);
            closingTextViewSebcValue = view.findViewById(R.id.allclosing_tv_sebc);
            closingTextViewEbcValue = view.findViewById(R.id.allclosing_tv_ebc);
            closingTextViewScValue = view.findViewById(R.id.allclosing_tv_sc);
            closingTextViewStValue = view.findViewById(R.id.allclosing_tv_st1);
        }
    }
}
