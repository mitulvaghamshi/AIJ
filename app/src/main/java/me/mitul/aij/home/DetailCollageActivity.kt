...
class DetailCollageActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        (findViewById<TextView>(R.id.college_detail_tv_fees_value))
            .text = String.format(getString(R.string.fees_collage), fees)
        ...
        this@DetailCollageActivity.setTitle(
            "${getString(R.string.collage_code)} ${(findViewById<TextView>(R.id.college_detail_tv_college_label)).getText()}"
        )
