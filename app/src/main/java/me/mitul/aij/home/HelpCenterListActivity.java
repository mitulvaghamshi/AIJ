...
public class HelpCenterListActivity extends Activity {
    ...
    private final HelperHelpCenter dbHelper = new HelperHelpCenter(HelpCenterListActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expListView.setOnChildClickListener((parent, view, groupPosition, childPosition, id) -> {
            PopupMenu popup = new PopupMenu(HelpCenterListActivity.this, view);
    ...
    private void prepareListData() {
        listDataHeader = dbHelper.selectCityForHelpCenter();
        listDataChild = new HashMap<>();
        list = listDataHeader;
        for (String name : listDataHeader) {
            listDataChild.put(name, new ArrayList<>(dbHelper.selectHelpCenter(name)));
        }
    }
}
