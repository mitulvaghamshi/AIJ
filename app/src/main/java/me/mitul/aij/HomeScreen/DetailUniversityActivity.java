...
public class DetailUniversityActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.universitydetail_tv_university_shortname)).setText(university.getUniversityShortName());
        ((TextView) findViewById(R.id.universitydetail_tv_university_fullname)).setText(university.getUniversityName());
        ((TextView) findViewById(R.id.universitydetail_tv_university_address)).setText(university.getUniversityAddress());
        ((TextView) findViewById(R.id.universitydetail_tv_university_phone)).setText(university.getUniversityPhone());
        ((TextView) findViewById(R.id.universitydetail_tv_university_website)).setText(university.getUniversityWebsite());
        ((TextView) findViewById(R.id.universitydetail_tv_university_email)).setText(university.getUniversityEmail());
        ((TextView) findViewById(R.id.universitydetail_tv_university_type)).setText(university.getUniversityType());
        Button universityButton = findViewById(R.id.universitydetail_tv_university_button);
        universityButton.setText(String.format(getString(R.string.collge_in_ss), university.getUniversityShortName()));
